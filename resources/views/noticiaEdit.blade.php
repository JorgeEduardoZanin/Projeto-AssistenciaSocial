<x-app-layout>
    <div class="flex justify-center">
        <div class="card-header text-2xl">Editar Notícias</div>
        <div class="card-body">
            <form action="{{ route('noticia.update', $noticia->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid gap-6 mb-6 lg:grid-cols-2 mt-9">
                    <div>
                        <label for="title" class="block mb-2 text-sm font-medium text-white dark:text-gray-300">Nome da Notícias</label>
                        <input type="text" id="title" name="title" value="{{ old('title', $noticia->title) }}"
                    ...
                    <div>
                        ...
                        <input type="text" id="description" name="description" value="{{ old('description', $noticia->description) }}"
