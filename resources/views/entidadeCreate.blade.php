<x-app-layout>
    <div class="max-w-2xl mx-auto p-16 mt-8 bg-gray-700 border rounded-lg">
        <form action="{{ route('entidade.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="grid gap-6 mb-6 lg:grid-cols-2 mt-9">
                ...
                <div>
                    <label for="hour" class="block mb-2 text-sm font-medium text-white dark:text-gray-300">Horario de Funcionamento</label>
